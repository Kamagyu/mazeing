...
enum Traversal { BFS, DFS, TRAV_COUNT };
...
int main(int argc, char **argv) {
  ...
  while (!WindowShouldClose()) {
    ...
    switch (traversal) {
    case BFS:
      trav_info = "Traversal: Breadth-First Search";
      break;
    case DFS:
      trav_info = "Traversal: Depth-First Search";
      break;
    default:
      trav_info = "Error getting traversal";
      break;
    }

    if (show_text)
      DrawText(trav_info, 5, 5, font_size, GREEN);
    EndDrawing();
